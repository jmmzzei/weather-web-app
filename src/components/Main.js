  ...
  return (
    <MainLayout>
      ...
      <WeatherData>
        ...
        {main.visibility && <Label text="Visibility" value={main.visibility} />}

        <Label text="Wind" value={main.wind.deg} winSpeed={main.wind.speed} />

        {main.sys.sunrise && <Label text="Sunrise" value={main.sys.sunrise} />}

        {main.sys.sunset && <Label text="Sunset" value={main.sys.sunset} />}
      </WeatherData>
    </MainLayout>
  )
}
